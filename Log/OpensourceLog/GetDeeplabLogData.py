...
def Get_deeplab_log_data(filepath):
    ...
    Class_IoU_0,Class_IoU_1,Class_IoU_2,Class_IoU_3=[list() for x in range(4)]
    ...
    for i in dictsdata:
        ...
        if 'val_score' in i:
            ...
            Class_IoU_3.append(i['val_score']['Class IoU'][3])
    ...
    return cur_itrs_loss,np_loss,cur_epochs,cur_itrs_epochs,interval_loss, \
           ...
           Class_IoU_0,Class_IoU_1,Class_IoU_2,Class_IoU_3,data_table,Dataset
               
            
if __name__=='__main__':
    
    data=Get_deeplab_log_data('./testlog.txt')
    #plt.plot(data[13])
    #plt.show()
    print(data[14]['model'])
    print(data[15])
