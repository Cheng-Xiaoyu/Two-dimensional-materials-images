...
Pixpath='./Pix/'
LogData = Get_deeplab_log_data('./log-2023-05-30-11-25-13.txt')
...
Class_IoU_3 = LogData[13]
data_table = LogData[14]
Dataset = LogData[15]
...
print('max(Mean_IoU):\t',round(max(Mean_IoU),4))
print('max(Class_IoU_0):\t',round(max(Class_IoU_0),4))
print('max(Class_IoU_1):\t',round(max(Class_IoU_1),4))
print('max(Class_IoU_2):\t',round(max(Class_IoU_2),4))
print('max(Class_IoU_3):\t',round(max(Class_IoU_3),4))
print('meanmaxIoU:\t',round(((round(max(Class_IoU_0),4)+round(max(Class_IoU_1),4)+round(max(Class_IoU_2),4)+round(max(Class_IoU_3),4))/4),4))
